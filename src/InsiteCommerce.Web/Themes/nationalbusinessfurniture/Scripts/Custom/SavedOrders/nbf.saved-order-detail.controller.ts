module insite.savedorders {
    ...
    export class NbfSavedOrderDetailController {
        cart: CartModel = null;
        canAddToCart = false;
        ...
        static $inject = ["cartService", "coreService", "spinnerService", "settingsService", "queryString", "addToWishlistPopupService", "productService"];
    ...
    angular
        .module("insite")
        .controller("NbfSavedOrderDetailController", NbfSavedOrderDetailController);
}