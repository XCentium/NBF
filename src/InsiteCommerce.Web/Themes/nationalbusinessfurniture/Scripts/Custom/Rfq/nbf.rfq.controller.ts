module insite.rfq {
    ...
    export class NbfRfqController {
        ...
        static $inject = ["coreService", "$scope", "cartService", "rfqService", "accountService", "sessionService", "settingsService", "$q", "productService"];
    ...
    angular
        .module("insite")
        .controller("NbfRfqController", NbfRfqController);
}