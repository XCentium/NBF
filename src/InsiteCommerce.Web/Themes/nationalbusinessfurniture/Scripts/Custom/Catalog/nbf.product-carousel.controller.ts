module insite.catalog {
    ...
    export class NbfProductCarouselController extends ProductCarouselController {
        ...
        constructor(
            ...
            super(cartService, productService, $timeout, addToWishlistPopupService, settingsService, $scope, $attrs, queryString, $stateParams);
        }
    ...
    angular
        .module("insite")
        .controller("ProductCarouselController", NbfProductCarouselController);
}