module nbf.shopthelook {
    ...
    export interface INbfShopTheLookCtaControllerAttributes extends ng.IAttributes {
    ...
    export class NbfShopTheLookCtaController {
        ...
        constructor(
            ...
            protected $attrs: INbfShopTheLookCtaControllerAttributes,
    ...
    angular
        .module("insite")
        .controller("NbfShopTheLookCtaController", NbfShopTheLookCtaController);
}