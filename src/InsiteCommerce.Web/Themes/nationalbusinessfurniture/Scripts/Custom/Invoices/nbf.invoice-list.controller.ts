module insite.invoice {
    ...
    export class NbfInvoiceListController {
        ...
        protected getInvoicesCompleted(invoiceCollection: InvoiceCollectionModel): void {
            ...
            if (this.invoiceStatusFilter != "-1") {
                this.invoiceHistory.invoices = this.invoiceHistory.invoices.filter(x => x.status == this.invoiceStatusFilter);
            }

            this.pagination = invoiceCollection.pagination;
            this.pagination.totalItemCount = invoiceCollection.invoices.length;
        }
    ...
    angular
        .module("insite")
        .controller("NbfInvoiceListController", NbfInvoiceListController);
}